...
All the functions require to pass an API key as a parameter to the function (because the underlying API endpoint requires it).
The API key is automatically generated for every registered user at <https://obsearth.com/app>.
You can find it under 'API Key' of your profile (top right) and copy it to the clipboard.
