...
These can be plotted on the world map, trajectory in red and the current position in red.
...
Again, we shall plot the footprints of the overpasses can be plotted, here we use only the neighboring countries and show the region of interest in red.
